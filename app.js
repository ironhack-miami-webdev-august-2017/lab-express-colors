...
app.use(colors.static('public'));

app.locals.myTitle = 'Hello, colors!';
...
app.get('/colorpage', (request, response, next) => {
  response.locals.listOfColors = allColors;
  response.render('colorpage.ejs');

});
app.get('/green', (request, response, next) => {
  response.locals.listOfColors = allColors;
  response.render('green.ejs');

});
app.get('/blue', (request, response, next) => {
  response.locals.listOfColors = allColors;
  response.render('blue.ejs');

});

app.get('/red', (request, response, next) => {
  response.locals.listOfColors = allColors;
  response.render('red.ejs');
